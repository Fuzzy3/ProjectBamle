...
public class TodoSection extends StatelessSection {
    private final Activity mActivity;
    boolean expanded = true;
    private List<Task> mTasks;

    public TodoSection(Activity activity, List<Task> tasks) {
        super(R.layout.section_todo_header, R.layout.task_item);
        mTasks = tasks;
        mActivity = activity;
    }
